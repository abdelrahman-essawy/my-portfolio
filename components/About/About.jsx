  ...
  return (
    ...
    >
      <m.div
        ...
        className={`grid max-w-screen-xl grid-cols-1 gap-4 px-6 pt-6 m-auto sm:gap-x-8 sm:px-8 sm:mt-2 sm:grid-cols-2 md:px-12 lg:px-16 xl:px-32 ${
          learnMore ? `sm:grid-cols-1` : ``
        }`}
      >
        <h2 className="hidden col-span-2 mb-6 text-3xl tracking-tight text-center text-blue-500 sm:block leading-2 sm:mb-10">
          About Me
        </h2>
        ...
        <m.div
          ...
          className={`hidden sm:block py-6 sm:p-0 sm:m-0 text-[0px] pointer-events-none select-none self-end w-96 ${
            learnMore ? `sm:hidden` : ``
          }`}
        >
          <Image
        ...
        <div className="m-auto">
          <h2 className="block mb-6 text-3xl tracking-tight text-center text-blue-500 sm:hidden leading-2 sm:mb-10">
            About Me
          </h2>
          <m.div
            animate={{ height }}
          ...
          <m.button
            ...
            className="my-8 text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 disabled:hover:bg-white focus:text-blue-700 dark:bg-transparent dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-2 dark:disabled:hover:bg-gray-800 focus:!ring-2 group flex h-min items-center justify-center p-0.5 text-center font-medium focus:z-10 rounded-lg"
            type="button"
          >
