  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="">
          <h2 className="text-3xl tracking-tight text-blue-500 leading-2 sm:mb-10 mb-6">
            About Me
          </h2>
          <m.div
            initial={{ opacity: 0, x: 10 }}
          ...
          >
            <ul className="list-disc px-5 sm:list-inside tracking-wide sm:tracking-tight">
              <li className="mb-2">
                <span className="font-bold">Energetic</span> university student
                with upcoming
                <span className="font-bold"> Bachelor of Science</span> degree.
              </li>
              <li className="mb-2">
                <span className="font-bold">Detail-oriented</span> and{" "}
                <span className="font-bold">motivated</span> to stay on task,
                Meet aggressive timelines and accomplish goals.
              </li>
              <li className="mb-2">
                <span className="font-bold">Strong analytical</span> and{" "}
                <span className="font-bold">organizational skills</span> within
                industry.
              </li>
            </ul>
          </m.div>
          ...
          >
            <p className="font-extralight text-gray-800 text-4xl sm:text-6xl">
              <span className="uppercase text-gray-500 text-3xl sm:text-5xl">
                +
              </span>
              79
              <span className="uppercase text-gray-500 text-2xl sm:text-2xl">
                {" "}
                projects
              </span>
            </p>
