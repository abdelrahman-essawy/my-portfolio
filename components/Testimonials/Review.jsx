...
const Review = ({ name, country, icon, desc }) =>
    <figure
        className="text-xs w-[calc(100vw_-_38px)] shadow-md px-4 py-10 sm:max-w-xl bg-zinc-50 rounded-xl  border-zinc-100 border h-fit">
