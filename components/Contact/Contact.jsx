  ...
  return (
    ...
    >
      <div className="px-12 sm:mt-8 sm:mx-0">
        <h2 className="text-3xl tracking-tight text-center text-blue-500 leading-2 ">
          Contact me
        </h2>
      </div>
          ...
          <div className="flex items-center justify-around gap-[.1rem] cursor-pointer ">
            <div className="transition ease-in duration-100  flex-grow p-2 rounded rounded-l-none bg-zinc-100 sm:hover:bg-zinc-200 active:bg-zinc-200">
              <img
                ...
                src="https://cdn-icons-png.flaticon.com/512/5075/5075620.png"
              />
            </div>
            ...
            <div className="transition ease-in duration-100  flex-grow p-2 rounded rounded-r-none bg-zinc-100 sm:hover:bg-zinc-200 active:bg-zinc-200">
              <img
                className={`w-8 h-8 m-auto`}
                src="https://cdn-icons-png.flaticon.com/512/4413/4413664.png"
              />
            </div>
          </div>
            ...
            <div>
              <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-2 py-4 mx-auto text-gray-900 bg-white rounded-lg shadow-lg sm:px-8 sm:py-16 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
                <div className="flex flex-col justify-between">
                  <div>
                    <h2 className="text-4xl font-bold leading-tight text-gray-700 lg:text-5xl">
                    ...
                    <div className="mt-8 text-gray-700">
                      ...
                      <Link
                        target="_blank"
                        rel="noreferrer"
                        href="https://mail.google.com/mail/u/0/?fs=1&to=abdelrahman.mo.essawy@gmail.com&tf=cm"
                        className="text-blue-400 underline sm:hover:text-blue-500 active:text-blue-500"
                      >
                        email
                      </Link>{" "}
                      instead.
                ...
                <div className>
                  <div>
                    ...
                    <input
                      className="w-full p-3 mt-2 text-gray-900 transition ease-in duration-100 rounded-lg focus:ring ring-blue-300 bg-zinc-100 focus:outline-none focus:shadow-outline"
                      type="text"
                      placeholder
                    />
                  </div>
                  <div className="sm:mt-8 mt-4">
                    ...
                    <input
                      className="transition ease-in duration-100 focus:ring ring-blue-300 w-full p-3 mt-2 text-gray-900 rounded-lg bg-zinc-100 focus:outline-none focus:shadow-outline"
                      type="text"
                    />
                  </div>
                  <div className="sm:mt-8 mt-4">
                    ...
                    <textarea
                      className="transition ease-in duration-100 focus:ring ring-blue-300 w-full h-32 p-3 mt-2 text-gray-900 rounded-lg bg-zinc-100 focus:outline-none focus:shadow-outline"
                      defaultValue={""}
                    />
                  </div>
                  <div className="sm:mt-8 mt-4">
      ...
      <div className="my-8 sm:px-0 sm:p-0 "></div>
    </m.section>
  );
}
