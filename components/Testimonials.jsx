...
export default function Testimonials() {
  ...
  return (
    <section
      id="TestimonialsID"
      className="bg-white py-6 px-4 sm:p-0 relative overflow-y-hidden"
    >
      <div className="px-12 my-8 sm:p-0">
        <h2 className="text-3xl tracking-tight text-blue-500 leading-2 text-center">
          Testimonials
        </h2>
        <h3 className="mt-3 font-medium  text-xl sm:tracking-wide text-gray-500 leading-2 text-center">
      ...
      <div className="max-screen-w-xl m-auto sm:px-12 my-8 sm:p-0  relative ">
        <div className="sm:block hidden bg-gradient-to-r from-white to-transparent sm:w-64 h-full absolute left-0 z-20">
          <div className="relative flex justify-start h-full w-full items-center">
            <button
              type="button"
              className="mx-8 z-50 rotate-180 text-gray-500  hover:text-gray-700 focus:outline-none "
            >
              <svg
                aria-hidden="true"
                className="w-8 h-8 "
        ...
        <div className="sm:block justify-between hidden bg-gradient-to-r from-transparent to-white sm:w-64 h-full absolute right-0 z-20">
          <div className="relative flex justify-end h-full w-full items-center">
            <button
              type="button"
              className="mx-8 z-50  text-gray-500  hover:text-gray-700 focus:outline-none "
            >
              <svg
                aria-hidden="true"
                className="w-8 h-8 "
        ...
        <div className=" flex center items-center sm:my-8 overflow-x-auto overflow-clip scroll-smooth scrollbar-hide snap-x snap-mandatory	 space-x-4 lg:space-x-8">
          {reviews.map((review, index) => {
            return (
              <div
                key={index}
                className="bg-zinc-50 block select-none rounded-md sm:hover:scale-105 snap-center sm:hover:shadow-xl shadow-sm sm:px-6 sm:py-8  border border-gray-100  sm:flex sm:justify-center sm:items-center"
              >
                <figure className="w-[calc(100vw_-_38px)] px-4 py-6 sm:max-w-xl">
                  ...
                  <blockquote>
                    <p className="text-center">
                      ...
                      <span className="text-md font-sans text-gray-900 dark:text-white">
                        {review.desc || <Skeleton count={4} />}
                      </span>
                      <span className="text-xl text-gray-400 font-mono">
                        &quot;
                      </span>
                  ...
                  <figcaption className="flex items-center  justify-center mt-6 space-x-3">
                    <Image
                      ...
                      src={review.icon || `/placeholder.png`}
                      alt="profile picture"
                    />
